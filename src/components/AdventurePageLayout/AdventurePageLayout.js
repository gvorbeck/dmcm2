...
function NpcTable(props) {
  ...
  return (
    <Box>
      <Paper>
        <Typography variant="h3">{NPCS}</Typography>
        <Divider />
        <TableContainer>
          <Table>
            <NpcTableHead
...
function Locations(props) {
  const { locations, parentAdventureSlug, parentAdventureTitle } = props;
